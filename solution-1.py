...
What are the expected outputs: the sum of all numbers between 1 and that number which should return a single integer

#input must be type integer. What if user inputs a differnt type?
# I need to clarify if 'between 1 and that number' includes 1
# 5+4+3+2+1 or 5+4+3+2

based on the example of running the program in the Problem Set 2019 I can see that it includes 1
the sum of all numbers between 10 and 1 is 55
